...
-module(cmdline_lexer).

-export([string/1,string/2,token/2,token/3,tokens/2,tokens/3]).
-export([format_error/1]).

%% User code. This is placed here to allow extra attributes.
-file("src/cmdline_lexer.xrl", 25).
...
-file("src/cmdline_lexer.erl", 276).
yystate() -> 18.
...
yystate(18, [113|Ics], Line, Tlen, Action, Alen) ->
    yystate(11, Ics, Line, Tlen+1, Action, Alen);
yystate(18, [83|Ics], Line, Tlen, Action, Alen) ->
    yystate(14, Ics, Line, Tlen+1, Action, Alen);
yystate(18, [82|Ics], Line, Tlen, Action, Alen) ->
    yystate(4, Ics, Line, Tlen+1, Action, Alen);
yystate(18, [81|Ics], Line, Tlen, Action, Alen) ->
...
yystate(18, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 58 ->
    yystate(20, Ics, Line, Tlen+1, Action, Alen);
yystate(18, [C|Ics], Line, Tlen, Action, Alen) when C >= 60, C =< 80 ->
    yystate(20, Ics, Line, Tlen+1, Action, Alen);
yystate(18, [C|Ics], Line, Tlen, Action, Alen) when C >= 84, C =< 112 ->
    yystate(20, Ics, Line, Tlen+1, Action, Alen);
yystate(18, [C|Ics], Line, Tlen, Action, Alen) when C >= 116 ->
    yystate(20, Ics, Line, Tlen+1, Action, Alen);
yystate(18, Ics, Line, Tlen, Action, Alen) ->
    {Action,Alen,Tlen,Ics,Line,18};
yystate(17, [105|Ics], Line, Tlen, Action, Alen) ->
    yystate(19, Ics, Line, Tlen+1, Action, Alen);
yystate(17, [73|Ics], Line, Tlen, Action, Alen) ->
    yystate(19, Ics, Line, Tlen+1, Action, Alen);
yystate(17, Ics, Line, Tlen, Action, Alen) ->
    {Action,Alen,Tlen,Ics,Line,17};
yystate(16, Ics, Line, Tlen, _, _) ->
    {6,Tlen,Ics,Line};
yystate(15, [109|Ics], Line, Tlen, Action, Alen) ->
    yystate(17, Ics, Line, Tlen+1, Action, Alen);
yystate(15, [77|Ics], Line, Tlen, Action, Alen) ->
    yystate(17, Ics, Line, Tlen+1, Action, Alen);
yystate(15, Ics, Line, Tlen, Action, Alen) ->
    {Action,Alen,Tlen,Ics,Line,15};
yystate(14, [113|Ics], Line, Tlen, _, _) ->
...
yystate(13, [68|Ics], Line, Tlen, Action, Alen) ->
    yystate(15, Ics, Line, Tlen+1, Action, Alen);
...
yystate(9, [65|Ics], Line, Tlen, Action, Alen) ->
    yystate(13, Ics, Line, Tlen+1, Action, Alen);
...
yystate(3, [84|Ics], Line, Tlen, Action, Alen) ->
    yystate(7, Ics, Line, Tlen+1, Action, Alen);
...
yystate(1, [107|Ics], Line, Tlen, Action, Alen) ->
    yystate(5, Ics, Line, Tlen+1, Action, Alen);
yystate(1, [75|Ics], Line, Tlen, Action, Alen) ->
    yystate(5, Ics, Line, Tlen+1, Action, Alen);
...
-file("src/cmdline_lexer.xrl", 12).
yyaction_0(TokenChars) ->
     { token, { sql, TokenChars } } .

-compile({inline,yyaction_1/1}).
-file("src/cmdline_lexer.xrl", 13).
yyaction_1(TokenChars) ->
     { token, { riak_admin, TokenChars } } .

-compile({inline,yyaction_2/1}).
-file("src/cmdline_lexer.xrl", 14).
yyaction_2(TokenChars) ->
     { token, { quit, TokenChars } } .

-compile({inline,yyaction_3/1}).
-file("src/cmdline_lexer.xrl", 15).
yyaction_3(TokenChars) ->
     { token, { q, TokenChars } } .

-compile({inline,yyaction_4/1}).
-file("src/cmdline_lexer.xrl", 16).
yyaction_4(TokenChars) ->
     { token, { semicolon, TokenChars } } .

-compile({inline,yyaction_5/1}).
-file("src/cmdline_lexer.xrl", 19).
yyaction_5(TokenChars) ->
     { token, { stuff, TokenChars } } .

-compile({inline,yyaction_6/0}).
-file("src/cmdline_lexer.xrl", 21).
yyaction_6() ->
     { end_token, { '$end' } } .
